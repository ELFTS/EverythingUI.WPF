...
public partial class MainWindow : Window
{
    ...
    {
        var names = new[] { "按钮", "开关", "复选框", "单选框", "输入框", "组合框", "滑块", "进度条", "圆形进度条", "卡片", "遮罩对话框", "侧边栏", "工具栏", "图标列表框", "列表视图", "右键菜单", "系统托盘" };
        var types = new[] { typeof(ButtonPage), typeof(ToggleSwitchPage), typeof(CheckBoxPage), typeof(RadioButtonPage),
            ...
            typeof(CircularProgressBarPage), typeof(CardPage), typeof(OverlayDialogPage), typeof(SideBarPage), typeof(ToolBarPage), typeof(IconListBoxPage), typeof(ListViewPage), typeof(ContextMenuPage), typeof(NotifyIconPage) };
