...
public static class ColorHelper
{
    ...
    public static Color GetGradientStartColor(ColorName colorName) => colorName switch
    {
        ...
        ColorName.Green => C("#A0D605"), ColorName.Cyan => C("#00BAAD"), ColorName.Purple => C("#AC33C1"),
        ColorName.Pink => C("#F7D7EC"),
        ColorName.Indigo => C("#5B7FFF"), ColorName.Sky => C("#38BDF8"), ColorName.Emerald => C("#34D399"),
        ColorName.Rose => C("#FB7185"), ColorName.Amber => C("#FBBF24"), ColorName.Violet => C("#8B5CF6"),
        ColorName.Coral => C("#FF7F7F"), ColorName.Mint => C("#6EE7B7"),
        _ => C("#00ACF0") // Blue（默认色，含 ColorName.Blue 及未知值）
    };
    ...
    public static Color GetGradientEndColor(ColorName colorName) => colorName switch
    {
        ...
        ColorName.Green => C("#19A654"), ColorName.Cyan => C("#00998F"), ColorName.Purple => C("#8D2C9E"),
        ColorName.Pink => C("#FF9CDB"),
        ColorName.Indigo => C("#4A6BE5"), ColorName.Sky => C("#0EA5E9"), ColorName.Emerald => C("#10B981"),
        ColorName.Rose => C("#E11D48"), ColorName.Amber => C("#D97706"), ColorName.Violet => C("#7C3AED"),
        ColorName.Coral => C("#FF5252"), ColorName.Mint => C("#34D399"),
        _ => C("#0078D4") // Blue（默认色）
    };
